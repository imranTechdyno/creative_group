...
Route::post('/sendhtmlemail',[MailController::class,'html_email']);
Route::get('/sendattachmentemail',[MailController::class,'attachment_email']);

Route::controller(SiteController::class)->group(function(){
    Route::get('/', 'index')->name('home');
    Route::get('{pages}', 'page')->name('pages');
    
    Route::get('/product-details/{slug}', 'product_details')->name('product_details');
    Route::get('/press-release/{slug}', 'press_release')->name('press_release');
    Route::get('/news-and-events-details/{slug}', 'news_and_events')->name('news_and_events');
    Route::get('/job-details/{slug}', 'career_details')->name('career_details');
    Route::get('/sister-concern-details/{slug}', 'sister_concern')->name('sister_concern');
});
