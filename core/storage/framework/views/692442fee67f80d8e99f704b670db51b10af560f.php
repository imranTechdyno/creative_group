...
<div class="page-title text-center">
    <p class="contact_tag1 text-center text-bold"><?php echo e(@$product_details->data->title); ?></p>
    <hr class="hr_for_all">
</div>
...
<?php echo $__env->make('frontend.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\New_Project\core\resources\views/frontend/sections/product_details.blade.php ENDPATH**/ ?>