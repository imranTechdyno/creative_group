                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $ourApproach; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $approach): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <div class="row employees">
                            <div class="col-sm-6 text-left">
                                <a href="#" class="hover-effect"><img src="<?php echo e($approach->data->image1); ?>"
                                        alt=""> </a>
                            </div>
                            <div class="col-sm-6">
                                <h4 class="subtitle"><?php echo e($approach->data->title_head1); ?></h4>
                                <p><?php echo e($approach->data->description1); ?></p>
                            </div>
                        </div>
                        <!-- data for 2nd image -->
                        <div class="row employees">
                            <div class="col-sm-6">
                                <h4 class="subtitle"><?php echo e($approach->data->title_head2); ?></h4>
                                <p><?php echo e($approach->data->description2); ?></p>
                            </div>
                            <div class="col-sm-6 text-right">
                                <a href="#" class="hover-effect">
                                    <img src="<?php echo e($approach->data->image2); ?>">
                                </a>
                            </div>
                        </div>
...
<?php /**PATH /home/novajwmx/unisoft.academiaitbd.com/core/resources/views/frontend/sections/our_approach.blade.php ENDPATH**/ ?>