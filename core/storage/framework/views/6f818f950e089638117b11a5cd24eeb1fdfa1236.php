                                                ...
                                                <?php elseif($sec == 'textarea'): ?>
                                                    <div class="form-group col-md-12">
                                                        ...
                                                        <label for=""><?php echo e(__(frontendFormatter($key))); ?>
                                                            ...
                                                            (<?php echo e(@$section['content']['max']); ?>)</label>
                                                    ...
                                                    <?php $__currentLoopData = $keys; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        ...
                                                        <?php if(
                                                            $key == 'heading_icon' ||
                                                                ...
                                                                $key == 'header' ||
                                                                $key == 'button_link'): ?>
                                                            <td><?php echo e(strip_tags(@$element->data->$key)); ?></td>
                                                        <?php endif; ?>
...
<?php $__env->startPush('script'); ?>
    <script>
        ...
        //     callbacks: {
        //         onBeforeSave: function(contents) {
        //             // Remove font-size style from the content
        //             var cleanedContent = contents.replace(/(<[a-zA-Z0-9\s"'-=\/]+) style="[^"]*"/gi, '$1');
            ...
            $('.summernote').summernote({
                callbacks: {
                    onBeforeSave: function(contents) {
                        console.log("Called");
                        // Remove font-size style from the content
                        var cleanedContent = contents.replace(
                            /(<[a-zA-Z0-9\s"'-=\/]+) style="[^"]*font-size:[^"]*"/gi, '$1');
                        return cleanedContent;
                    }
                }
            });
...
<?php echo $__env->make('backend.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\unisoftdynamic\core\resources\views/backend/frontend/index.blade.php ENDPATH**/ ?>