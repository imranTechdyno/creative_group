...
<section class="card_container">
    <div class="container">
        <div class="sister"><?php echo e(@$clientContent->data->title); ?></div>
        <div class="row">
            <div class="blue">
...
<!-- Our corporate client ends --><?php /**PATH /home/novajwmx/unisoft.academiaitbd.com/core/resources/views/frontend/sections/client.blade.php ENDPATH**/ ?>