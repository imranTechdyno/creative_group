<?php if(Session::has('alert.config') || Session::has('alert.delete')): ?>
    ...
    <?php if(config('sweetalert.alwaysLoadJS') === false && config('sweetalert.neverLoadJS') === false): ?>
        <script src="<?php echo e(asset('asset/frontend/js/sweetalert.js')); ?>"></script>
    <?php endif; ?>
    <script>
...
<?php endif; ?>
<?php /**PATH /home/novajwmx/unisoft.academiaitbd.com/core/resources/views/vendor/sweetalert/alert.blade.php ENDPATH**/ ?>