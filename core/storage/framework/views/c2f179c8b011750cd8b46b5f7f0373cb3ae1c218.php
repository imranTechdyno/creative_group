                ...
                <div class="newsletter widget ico">
                    ...
                    <div class="widgets-social">
                        ...
                        <a href="<?php echo e($general->youtube); ?>" class="youtube">
                            <i class="fa-brands fa-youtube" aria-hidden="true" style="color: #f00000;padding-top: 6px;
                            font-size: 22px;"></i>
                        </a>
                    </div>
    ...
    <div class="copyright">
        <div class="container">
            <div class="row copyright-bar">
                <div class="col-md-12">
                    <p>
                        Copyright©2022 Unisoft All rights reserved. Design and Developed by <a href="https://www.techdynobd.com/" ><span class="tdbd_url">Techdyno BD Ltd.</span></a>
                    </p>
                </div>
...
<?php /**PATH C:\laragon\www\unisoftdynamic\core\resources\views/frontend/layout/footer.blade.php ENDPATH**/ ?>