                                                ...
                                                <tr class="text-center">
                                                    ...
                                                    <?php $__currentLoopData = $keys; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <?php if($key == 'size' ||$key == 'unique' ): ?>
                                                            <?php continue; ?>
                                                        <?php endif; ?>
                                                        <?php if($key=='heading_icon'||$key=='percentage'||$key == 'video_cloud_link'|| $key=='social_icon'|| $key=='question' ||$key=='social_link' || $key=='item'|| $key == 'title' || $key=='name' || $key=='designation' || $key=='header' ||$key == 'button_link'): ?>
