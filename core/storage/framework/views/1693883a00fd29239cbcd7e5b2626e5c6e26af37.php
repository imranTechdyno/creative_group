                                                ...
                                                <tr class="text-center">
                                                    ...
                                                    <?php $__currentLoopData = $keys; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <?php if($key == 'size' ||$key == 'unique' ): ?>
                                                            <?php continue; ?>
                                                        <?php endif; ?>
                                                        <?php if($key=='heading_icon'||$key=='percentage' || $key=='date'|| $key=='glance_number' || $key=='glace_number'  || $key == 'video_cloud_link'|| $key=='social_icon'|| $key=='question' ||$key=='social_link' || $key=='item'|| $key == 'title' || $key=='name' || $key=='designation' || $key=='header' ||$key == 'button_link'): ?>
...
<?php echo $__env->make('backend.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/novajwmx/unisoft.academiaitbd.com/core/resources/views/backend/frontend/index.blade.php ENDPATH**/ ?>