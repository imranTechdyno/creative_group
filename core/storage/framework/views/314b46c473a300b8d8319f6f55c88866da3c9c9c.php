...
<?php $__env->startSection('content'); ?>
    ...
    <section class="home-publications product_bg">
        <div class="container">
            <div class="job-h">
                <h3 style="color:#C61D23">Apply For <?php echo e($career_details->data->job_title); ?></h3>
            </div>
...
<?php echo $__env->make('frontend.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\New_Project\core\resources\views/frontend/sections/job_details.blade.php ENDPATH**/ ?>