                    ...
                    <div class="col-md-12 box" style="border: none!important">
                        ...
                        <div class="col-md-6 col-sm-12 col-12" style="vertical-align: middle">
                            <div class="" style="padding-top:20px">
                                <h3><?php echo e(@$product_details->data->title); ?></h3>
                                <p style="padding-left: 0px!important" class="text-justify"><?php echo e(strip_tags(@$product_details->data->short_description)); ?></p>
                            </div>
                        </div>
                ...
                <div class="">
                    <div class="">
                        <div class="col-md-9 col-sm-12 col-12 box product_des">
                            <div class="">
                                <h3>Description:</h3>
                                <p class="text-justify"><?php echo e(strip_tags(@$product_details->data->description)); ?></p>
                            </div>
                        </div>
...
<?php echo $__env->make('frontend.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\unisoft\core\resources\views/frontend/sections/product_details.blade.php ENDPATH**/ ?>