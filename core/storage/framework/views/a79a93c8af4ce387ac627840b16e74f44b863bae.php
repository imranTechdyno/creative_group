...
<head>
    ...
    <!-- HTML Meta Tags -->
    <meta name="description" content=" <?php echo e(__(@$seo_description)); ?>">

    <!-- Google / Search Engine Tags -->
    <meta itemprop="name" content=" <?php echo e(__(@$pageTitle)); ?>">
    <meta itemprop="description" content=" <?php echo e(__(@$seo_description)); ?>">
    <meta itemprop="image" content="<?php echo e(getFile('logo', @$general->logo)); ?>">

    <!-- Facebook Meta Tags -->
    <meta property="og:type" content="website">
    <meta property="og:title" content=" <?php echo e(__(@$pageTitle)); ?>">
    <meta property="og:description" content=" <?php echo e(__(@$seo_description)); ?>">
    <meta property="og:image" content="<?php echo e(getFile('logo', @$general->logo)); ?>">

    <!-- Twitter Meta Tags -->
    <meta name="twitter:card" content="summary_large_image">
    <meta name="twitter:title" content=" <?php echo e(__(@$pageTitle)); ?>">
    <meta name="twitter:description" content=" <?php echo e(__(@$seo_description)); ?>">
    <meta name="twitter:image" content="<?php echo e(getFile('logo', @$general->logo)); ?>">
    ...
    <link href="<?php echo e(asset('asset/frontend/css/magnific-popup.css')); ?>" rel="stylesheet" />
...
<?php /**PATH /home/novajwmx/unisoft.academiaitbd.com/core/resources/views/frontend/layout/master.blade.php ENDPATH**/ ?>