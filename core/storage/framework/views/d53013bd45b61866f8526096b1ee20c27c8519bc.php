    ...
    <div class="container">
        ...
        <div class="row company">
            ...
            <div class="col-lg-6 col-md-12">
                ...
                <div class="lea">
                    <a href="" class="learn">Learn More <i class="fa-sharp fa-solid fa-arrow-right"></i></a>
                </div>
            </div>
        </div>
    </div>
...
<?php $__env->stopPush(); ?>
<?php /**PATH C:\laragon\www\unisoftfinal\core\resources\views/frontend/sections/about.blade.php ENDPATH**/ ?>