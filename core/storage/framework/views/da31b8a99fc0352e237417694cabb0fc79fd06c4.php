                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-2">
                                        ...
                                        <input type="text" name="phone" placeholder="<?php echo app('translator')->get('Phone Number'); ?>"
                                            class="form-control form_control" value="<?php echo e(@$general->phone_no); ?>">
                                    </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('backend.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\unisoft\core\resources\views/backend/setting/general_setting.blade.php ENDPATH**/ ?>