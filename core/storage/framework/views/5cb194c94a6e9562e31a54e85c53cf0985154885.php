                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group w-25">
                                                        <label class="col-form-label"><?php echo e(__(frontendFormatter($key))); ?>
                                                            ...
                                                            (<?php echo e(@$section['size']); ?>)
                                                        </label>

                                                        <div id="image-preview_<?php echo e($count); ?>" class="image-preview">
                                                            <label for="image-upload_<?php echo e($count); ?>"
                                                                id="image-label_<?php echo e($count); ?>"><?php echo e(__('Choose File')); ?></label>
                                                            <input type="<?php echo e($sec); ?>" name="<?php echo e($key); ?>"
                                                                id="image-upload_<?php echo e($count); ?>" />
                                                        </div>
...
<?php $__env->startPush('script'); ?>
    <script>
        $(function() {
            ...
            var count = Number(<?php echo e($count); ?>)
...
<?php echo $__env->make('backend.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\unisoftdynamic\core\resources\views/backend/frontend/element.blade.php ENDPATH**/ ?>