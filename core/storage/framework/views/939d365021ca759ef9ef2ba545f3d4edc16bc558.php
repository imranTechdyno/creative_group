                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    ...
                    <ul class="nav navbar-nav main-menu">
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li><a href="<?php echo e(url('all-sister-concern')); ?>">All Sister Concern </a></li>
                                ...
                                <li><a target="_blank" href="<?php echo e($item->data->url); ?>"><?php echo e($item->data->title); ?></a></li>
...
<!-- header section close --><?php /**PATH /home/novajwmx/unisoft.academiaitbd.com/core/resources/views/frontend/layout/header.blade.php ENDPATH**/ ?>